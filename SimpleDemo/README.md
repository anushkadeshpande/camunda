...
[camunda-archetype-servlet-war-7.21.0](https://docs.camunda.org/manual/latest/user-guide/process-applications/maven-archetypes/).
...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/com/camunda/demo/SimpleDemo/ProcessTest.java) in your IDE or using:
